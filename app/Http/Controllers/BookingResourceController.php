...
class BookingResourceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (@$_GET['export'] == 'excel') {
            ...
            header("Content-Disposition: attachment; filename=จองทรัพยากร_".date('Ymdhis').".xls");  //File name extension was wrong
            header("Expires: 0");
    ...
    public function store(BookingResourceRequest $request)
    {
        ...
        $rs->code = $data->st_resource->code.sprintf("%05d", $data->id);
        $rs->save();
