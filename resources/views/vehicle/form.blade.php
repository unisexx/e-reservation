...
<tr>
  ...
  <option>-- เลือกประเภทรถ --</option>
    ...
    <input name="textarea4" type="text" class="form-control" id="textarea4" placeholder="ยี่ห้อ" style="width:300px;"/></div></td>
</tr>
<tr>
  <th>ที่นั่ง<span class="Txt_red_12"> *</span> / สี <span class="Txt_red_12"> *</span> / เลขทะเบียน<span class="Txt_red_12"> *</span></th>
  <td><div class="form-inline">
  <input name="textarea7" type="text" class="form-control" id="textarea7" placeholder="ที่นั่ง" style="width:100px;"/>
    <input name="textarea4" type="text" class="form-control" id="textarea4" placeholder="สี" style="width:200px;"/>
    <input name="textarea4" type="text" class="form-control" id="textarea4" placeholder="เลขทะเบียน" style="width:200px;"/>
    </div></td>
</tr>
<tr>
