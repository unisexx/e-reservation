...
<div class="form-group form-inline col-md-12 input-daterange">
    ...
    <input name="start_date" type="text" class="form-control fdate range-date {{ $errors->has('start_date') ? 'has-error' : '' }}" value="{{ isset($rs->start_date) ? DB2Date($rs->start_date) : old('start_date') }}" style="width:120px;" required/>
