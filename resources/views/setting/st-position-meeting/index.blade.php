...
<h3>ตั้งค่า ตำแหน่งการประชุม/พิธี</h3>
<div id="search">
    <div id="searchBox">
        <form method="GET" action="{{ url('/setting/st-position-meeting') }}" accept-charset="UTF-8" class="form-inline" role="search">
...
@if(CanPerm('st-position-meeting-create'))
<div id="btnBox">
    <input type="button" value="เพิ่มรายการ" onclick="document.location='{{ url('/setting/st-position-meeting/create') }}'"
    ...
    @foreach($rs as $key=>$item)
        <tr @if(($key % 2) == 1) class="odd" @endif>
            ...
            <td>
                ...
                @if(CanPerm('st-position-meeting-edit'))
                <a href="{{ url('/setting/st-position-meeting/' . $item->id . '/edit') }}" title="แก้ไข">
