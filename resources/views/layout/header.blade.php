...
<div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
          	<li><a href="{{ url('/booking_room') }}"><img src="{{ url('images/booking_room.png') }}" width="32" height="32" /> จองห้องประชุม</a></li>
			<li><a href="{{ url('/booking_vehicle') }}"><img src="{{ url('images/booking_vehicle.png') }}" width="32" height="32" /> จองยานพาหนะ</a></li>
         ...
         <ul class="nav navbar-nav navbar-right">
          	 <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="{{ url('images/setting.png') }}" width="24" height="24" /> ตั้งค่าข้อมูลหลัก <span class="caret"></span></a>
              <ul class="dropdown-menu submenu" style="height:auto; max-height:450px; overflow-x: hidden;">
          ...
          <li><a href="{{ url('/user/form') }}" class="vtip" title="StaSty [Super Admin]"><img src="{{ url('images/user_info.png') }}" width="16" height="16" /></a></li>
            <li><a href="{{ url('/logout') }}"><img src="{{ url('images/logout.png') }}" width="16" height="16" class="vtip" title="ออกจากระบบ" /></a></li>
          </ul>
