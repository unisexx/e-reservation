...
<div id="btnBox">
    ...
    <input type="button" title="+ ขอจองทรัพยากร" value="+ ขอจองทรัพยากร" onclick="document.location='{{ url('/booking-resource/create') }}'" class="btn btn-success vtip" />
    @endif
</div>

@include('include._color_status', ['type'=>'resource'])
